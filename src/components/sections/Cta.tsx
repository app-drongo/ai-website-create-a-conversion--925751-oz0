...
export default function CTA() {
  const stats = [
    { value: "10K+", label: "Apps Built", icon: Zap },
    { value: "99.9%", label: "Uptime", icon: Shield },
    { value: "500+", label: "Startups Launched", icon: Users },
    { value: "24/7", label: "Founder Support", icon: Sparkles }
  ]
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold mb-6 leading-tight">
                ...
                <span className="block bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">
                  Reality Without Code
                </span>
              </h2>

              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join thousands of entrepreneurs who've built successful startups with Techo. 
                From MVP to market leader - all without writing a single line of code.
              </p>
              ...
              <div className="text-center mb-12">
                <p className="text-sm text-muted-foreground mb-6">
                  Trusted by innovative startups and entrepreneurs worldwide
                </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Free MVP Builder</h3>
              <p className="text-sm text-muted-foreground">
                14 days free, no credit card, start building immediately
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Launch in Days</h3>
              <p className="text-sm text-muted-foreground">
                From idea to live app in days, not months
              </p>
            </div>
          </div>
        </div>

...
export default function Footer() {
  ...
  const socialLinks = [
    { name: "Twitter", icon: Twitter, href: "https://twitter.com/techo" },
    { name: "Facebook", icon: Facebook, href: "https://facebook.com/techo" },
    { name: "Instagram", icon: Instagram, href: "https://instagram.com/techo" },
    { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/company/techo" },
    { name: "GitHub", icon: Github, href: "https://github.com/techo" }
  ]
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              <Link href="/" className="flex items-center space-x-2 mb-4">
                ...
                <span className="font-bold text-xl text-foreground">Techo</span>
              </Link>
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                Empowering creators and entrepreneurs to build powerful applications without code. 
                Join thousands of innovators who are transforming their ideas into reality with our no-code platform.
              </p>
            </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="text-muted-foreground">hello@techo.com</span>
              </div>
              <div className="flex items-center gap-3 text-sm">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Get the latest no-code tips, product updates, and exclusive offers. Unsubscribe anytime.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
              <span>© 2024 Techo. All rights reserved.</span>
              <span className="hidden sm:inline">•</span>
              <span className="hidden sm:inline flex items-center gap-1">
                Made with <Heart className="size-3 text-accent fill-current" /> for no-code creators
              </span>
            </div>
